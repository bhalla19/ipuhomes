...
<body class="bg-[#bdb9b3]">
    ...
    <div class="flex">
        <div class="">
            <a href="{{route('bediPG')}}"><img src="{{ 'images/pgroom3.jpg' }}" alt=""
                class="w-40 ml-1 mt-9 rounded-xl border-2 border-[#892c6c] md:w-96 md:mt-12 md:ml-12 md:rounded-xl md:border-2 md:border-solid md:border-[#892c6c]"></a>
            <h1
                class="font-mono text-sm text-[#892c6c] ml-3 mt-1 md:ml-20 md:text-xl md:font-mono md:font-medium md:mt-2 md:text-[#892c6c]">
                Bedi Guest House</h1>
        </div>
    </div>
</body>
